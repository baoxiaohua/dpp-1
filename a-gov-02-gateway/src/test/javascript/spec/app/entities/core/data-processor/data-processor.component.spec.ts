...
import { DataProcessorComponent } from 'app/entities/core/data-processor/data-processor.component';
...
describe('Component Tests', () => {
    describe('DataProcessor Management Component', () => {
        let comp: DataProcessorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DataProcessorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.dataProcessors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
