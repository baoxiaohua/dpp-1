...
import { SystemQueryComponent } from 'app/entities/core/system-query/system-query.component';
...
describe('Component Tests', () => {
    describe('SystemQuery Management Component', () => {
        let comp: SystemQueryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SystemQueryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.systemQueries[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
