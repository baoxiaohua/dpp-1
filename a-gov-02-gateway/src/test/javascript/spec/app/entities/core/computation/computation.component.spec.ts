...
import { ComputationComponent } from 'app/entities/core/computation/computation.component';
...
describe('Component Tests', () => {
    describe('Computation Management Component', () => {
        let comp: ComputationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ComputationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.computations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
